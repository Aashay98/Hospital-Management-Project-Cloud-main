...
def contact_list(request):
    url="https://9siq2vg3r1.execute-api.us-east-1.amazonaws.com/v1/contactus"
    headers = {'content-type':'application/json'}
    r = requests.get(url,headers=headers)
    api_request = json.loads(r.content)
    print("data:",api_request)
    if r.status_code == 200:
        return render(request, 'hospital/contact_list.html', {"data":api_request})
    else:
        return render(request, 'hospital/contact_list.html')
